...
(() => {
  ...
  var e = {
      487: (e, t, n) => {
        ...
        l.push([
          e.id,
          "#navbar{overflow:hidden;margin:0;padding:0 0 0 0;background-color:gray;display:flex;justify-content:space-between}#navbar a{float:left;display:block;color:#f2f2f2;text-align:center;padding:14px;text-decoration:none}",
          "",
        ]);
        const a = l;
      },
      ...
      448: (e, t, n) => {
        ...
        function Hl() {
          if (!Dl && null !== Il) {
            ...
            try {
              ...
              throw (null !== Il && (Il = Il.slice(e + 1)), El(Nl, $l), t);
            } finally {
              Dl = !1;
            }
          }
        ...
        function Ba(e) {
          ...
          } else Fa = Ia ? $r(e.stateNode.nextSibling) : null;
          return !0;
        }
        function Wa() {
          (Fa = Ia = null), (Da = !1);
        ...
        function nu(e) {
          switch (e.tag) {
            ...
            case 3:
              if ((La(), ol(cl), ol(sl), Ha(), 0 != (64 & (t = e.flags))))
                throw Error(o(285));
        ...
        function wu(e, t) {
          switch (t.tag) {
            ...
            case 13:
              return (
                null !== t.memoizedState && ((Au = Al()), du(t.child, !0)),
                void ku(t)
              );
            case 19:
              return void ku(t);
        ...
        function ii(e, t, n) {
          ...
          Bt(e, t, n), e === Pu && ((Fu |= t), 4 === Ou && di(e, Tu));
          var r = jl();
          1 === t
            ? 0 != (8 & Cu) && 0 == (48 & Cu)
              ? pi(e)
        ...
        function fi(e) {
          ...
          if (
            ...
            if (
              ...
              throw ((t = Mu), yi(e, 0), di(e, n), ci(e, Al()), t);
            switch (
              ...
              case 3:
                if (
                  (di(e, n), (62914560 & n) === n && 10 < (r = Au + 500 - Al()))
                ) {
                  if (0 !== Dt(e, 0)) break;
        ...
        function pi(e) {
          ...
          if (
            ...
            throw ((n = Mu), yi(e, 0), di(e, t), ci(e, Al()), n);
          return (
        ...
        function Pi(e, t) {
          ...
          if (
            ...
            (Kt = !!Dr), (Ur = Dr = null), (e.current = n), (Wu = r);
            do {
              try {
                for (b = e; null !== Wu; ) {
                  var S = Wu.flags;
          ...
          if (qu) (qu = !1), (Ku = e), (Yu = t);
            ...
            for (Wu = r; null !== Wu; )
              (t = Wu.nextEffect),
                (Wu.nextEffect = null),
                8 & Wu.flags &&
                  (((S = Wu).sibling = null), (S.stateNode = null)),
                (Wu = t);
          if (
        ...
        function Ni() {
          for (; null !== Wu; ) {
            ...
            ai ||
              ...
              (0 != (8 & Wu.flags)
                ? Je(Wu, li) && (ai = !0)
                : 13 === Wu.tag && Eu(e, Wu) && Je(Wu, li) && (ai = !0));
            var t = Wu.flags;
            0 != (256 & t) && cu(e, Wu),
              0 == (512 & t) ||
                qu ||
        ...
        function r(e, r) {
          for (var a = {}, o = [], u = 0; u < e.length; u++) {
            ...
            -1 !== d
              ...
              : t.push({ identifier: f, updater: l(p, r), references: 1 }),
              o.push(f);
          }
          return o;
        }
    ...
    (() => {
      ...
      const r = function () {
          return e.createElement(
            ...
            e.createElement(
              "form",
              { className: "newChallengeForm" },
              e.createElement("input", { placeholder: "add challenge" })
            ),
            e.createElement(
              "form",
              { className: "inviteUsersForm" },
              e.createElement("input", { placeholder: "invite users" })
            ),
            e.createElement(
              "form",
              { className: "wagerForm" },
              e.createElement("input", { placeholder: "wager" })
            )
          );
        },
        l = function () {
          return e.createElement(
            "div",
            { id: "navbar" },
            e.createElement("a", { href: "#" }, "Appcountability"),
            e.createElement("a", { href: "#" }, "where icon should be"),
            e.createElement("a", { rhef: "#" }, "User credentials")
          );
        },
        a = function () {
          return e.createElement(
      ...
      (b.styleTagTransform = g()),
        ...
        t.render(e.createElement(a, null), document.getElementById("root"));
    })();
})();
